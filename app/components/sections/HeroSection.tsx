...
export const HeroSection = () => (
  <section id="hero" className="min-h-screen flex items-center w-full px-6 sm:px-20 md:px-32 lg:px-48 py-24 overflow-hidden">
    <div className="max-w-7xl mx-auto w-full grid grid-cols-12 gap-8 items-end relative">
      ...
      <div className="col-span-12 md:col-span-4 flex flex-col justify-end space-y-6 md:space-y-8 order-3 md:order-1 relative z-20">
        ...
        <motion.p 
          ...
          className="text-on-surface-variant font-light leading-relaxed max-w-sm md:max-w-xs text-sm md:text-base"
        >
      ...
      >
        <motion.div 
          ...
          className="relative w-full max-w-sm md:max-w-2xl aspect-[4/5] mb-[-120px] md:mb-[-340px]"
        >
          <img 
      ...
      <div className="col-span-12 md:col-span-4 md:col-start-9 flex flex-col justify-end items-center md:items-end text-center md:text-right space-y-6 md:space-y-8 order-2 md:order-3 relative z-20 translate-y-0 md:translate-y-32">
        <motion.div 
          initial={{ width: 0 }}
          animate={{ width: "auto" }}
          className="font-label uppercase tracking-[0.2em] text-primary text-[10px] md:text-xs flex items-center justify-center md:justify-end gap-3 md:gap-4 overflow-hidden whitespace-nowrap"
        >
